import { DefaultButton, Icon, IconButton, Pivot, PivotItem, Stack, PrimaryButton } from '@fluentui/react';
...
export default (props: ChatHeaderDispatchProps & ChatHeaderProps & ChatHeaderPaneProps): JSX.Element => {
    ...
    const videoCallSrting = 'Video Call';

    const { topic, generateHeaderMessage, leaveChatHandler, startCallHandler, removeChatParticipantById, userId } = props;
                ...
                <Stack horizontal={true}>
                    ...
                    <Stack.Item align="center">
                        ...
                        <div className={largeButtonContainerStyle}>
                            ...
                            >
                                <Icon iconName="Video" className={copyIconStyle} />
                                {videoCallSrting}
                            </DefaultButton>
                        </div>
                    </Stack.Item>
