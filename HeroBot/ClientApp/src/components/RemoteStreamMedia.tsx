...
import { getStreamId } from '../utils/utils';
import staticMediaSVG from '../assets/call/staticmedia.svg';
...
export default (props: RemoteStreamMediaProps): JSX.Element => {
  ...
  const streamId = props.stream ? getStreamId(props.label, props.stream) : `${props.label} - no stream`;
