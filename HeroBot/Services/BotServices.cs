...
namespace HeroBot.Services
{
    public class BotServices : IBotServices
    {
        ...
        public LUISRuntimeClient LuisWeatherRuntimeClient(IConfiguration configuration)
        {
            var client = new LUISRuntimeClient(new ApiKeyServiceClientCredentials(configuration["LuisAPIKey"]));
            client.Endpoint = configuration["LuisAPIHostName"];
            return client;
